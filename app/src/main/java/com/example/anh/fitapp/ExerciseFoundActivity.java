...
public class ExerciseFoundActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lookedFor = (TextView) findViewById(R.id.muscle_name);
    ...
    public class ExercisesInfo extends AsyncTask<String, Object, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                //the url is built with the input of the user
                InputStream input = new URL("https://wger.de/api/v2/exercise/?format=json&language=2&name=" + searched_name).openStream();
                BufferedReader reader = new BufferedReader(new InputStreamReader(input));
                StringBuilder result = new StringBuilder();
                String line;
                while((line = reader.readLine()) != null) {
